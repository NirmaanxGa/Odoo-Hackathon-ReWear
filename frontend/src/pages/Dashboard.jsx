      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-gray-50 p-6 text-center">
            <div className="text-2xl font-light text-gray-900 mb-1">{stats.totalUploads}</div>
          ...
          <div className="bg-gray-50 p-6 text-center">
            <div className="text-2xl font-light text-gray-900 mb-1">{stats.totalViews}</div>
            <div className="text-sm text-gray-600">Profile Views</div>
          </div>
          <div className="bg-gray-50 p-6 text-center">
            <div className="text-2xl font-light text-gray-900 mb-1">{stats.totalContacts}</div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {recentActivity.slice(0, 5).map((activity) => (
                  <div key={activity.id} className="flex items-center justify-between p-4 border border-gray-200">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-sm">
                          {activity.type === 'contact' ? 'Contacted about' :
                           activity.type === 'exchange-request' ? 'Exchange requested for' : 'Uploaded'}{' '}
                          {activity.item.title}
                        </p>
            ...
            <div>
              ...
              <div className="max-w-2xl space-y-6">
                <div className="flex items-center mb-6">
                  <img
                    src={user?.imageUrl || 'https://via.placeholder.com/100x100?text=Avatar'}
                    alt="Profile"
